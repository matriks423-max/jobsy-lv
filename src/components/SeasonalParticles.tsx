...
function snowflakeSVG() {
  return (
    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
      <line x1="8" y1="1" x2="8" y2="15" stroke="#FF7F50" strokeWidth="1.5" strokeLinecap="round"/>
      <line x1="1" y1="8" x2="15" y2="8" stroke="#FF7F50" strokeWidth="1.5" strokeLinecap="round"/>
      <line x1="2.93" y1="2.93" x2="13.07" y2="13.07" stroke="#FF7F50" strokeWidth="1.5" strokeLinecap="round"/>
      <line x1="13.07" y1="2.93" x2="2.93" y2="13.07" stroke="#FF7F50" strokeWidth="1.5" strokeLinecap="round"/>
      <circle cx="8" cy="8" r="1.5" fill="#FF7F50"/>
    </svg>
  );
}
...
function petalSVG() {
  return (
    <svg width="12" height="18" viewBox="0 0 12 18" fill="none" xmlns="http://www.w3.org/2000/svg">
      <ellipse cx="6" cy="9" rx="5" ry="8" fill="#FF7F50" opacity="0.7" transform="rotate(-20 6 9)"/>
    </svg>
  );
}
...
function leafSVG() {
  return (
    <svg width="14" height="18" viewBox="0 0 14 18" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M7 1 C12 4 13 10 7 17 C1 10 2 4 7 1Z" fill="#FF7F50" opacity="0.75"/>
      <line x1="7" y1="3" x2="7" y2="16" stroke="#F5F1E8" strokeWidth="0.8" strokeLinecap="round"/>
    </svg>
  );
}
