...
export const translations = {
  lv: {
    ...
    pricing: {
      ...
      faq1a: "Bezmaksas konts paredzēts privātpersonām ar 1 vajadzību. Ja publicē regulāri vai turies vairākus sludinājumus vienlaicīgi — Business ir tava izvēle.",
      faq2q: "Kas notiek, kad atceļu Business?",
      faq2a: "Sludinājumi paliek aktīvi līdz to derīguma termiņam. Tu pāreji uz bezmaksas plānu — paliek 1 aktīvs limits.",
  ...
  ru: {
    ...
    pricing: {
      ...
      faq1a: "Бесплатный аккаунт предназначен для частных лиц с 1 потребностью. Если вы публикуете регулярно — Business для вас.",
      faq2q: "Что происходит при отмене Business?",
      faq2a: "Объявления остаются активными до истечения срока. Возвращается лимит 1 активного объявления.",
  ...
  en: {
    ...
    pricing: {
      ...
      faq1a: "The free plan is for individuals with one need. If you post regularly or need multiple listings at once, Business is the right fit.",
      faq2q: "What happens when I cancel Business?",
      faq2a: "Posts stay active until expiry. You return to the 1 active post limit.",
