...
export const translations = {
  lv: {
    ...
    pricing: {
      ...
      boostAlaCarte: "Boost à la carte",
      ...
      loading: "Ielādē...",
      boostForAll: "Boost — pieejams visiem",
      boostForAllDesc: "Maksā tikai par to, ko izmanto.",
    },
    userProfile: {
      member: "Biedrs",
  ...
  ru: {
    ...
    pricing: {
      ...
      loading: "Загрузка...",
      boostForAll: "Boost — для всех",
      boostForAllDesc: "Платите только за то, что используете.",
    },
    userProfile: {
      member: "Участник",
  ...
  en: {
    ...
    pricing: {
      ...
      loading: "Loading...",
      boostForAll: "Boosts — available to everyone",
      boostForAllDesc: "Pay only for what you use.",
    },
    userProfile: {
      member: "Member",
