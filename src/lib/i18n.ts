...
export const translations = {
  lv: {
    ...
    howItWorks: {
      ...
      step1Desc:
        "Vai meklē palīdzību, vai piedāvā savus pakalpojumus — tas ir pilnīgi bezmaksas!",
    ...
    ctaBanner: {
      ...
      subtitle: "Visi sludinājumi ir bezmaksas. Izcel savu sludinājumu ar Boost opciju.",
    ...
    createPost: {
      ...
      deleteCancel: "Atcelt",
      deleteBtn: "Dzēst",
      info: "Sludinājums ir bezmaksas. Aktīvs 30 dienas.",
      privacy: "Privātuma politika",
      terms: "Lietošanas noteikumi",
    },
    myPosts: {
    ...
    category: {
      ...
      ctaSubtitle: "Publicē sludinājumu — tas ir bezmaksas!",
    },
    cookie: {
  ...
  ru: {
    ...
    howItWorks: {
      ...
      step1Desc:
        "Ищешь помощь или предлагаешь услуги — это полностью бесплатно!",
    ...
    ctaBanner: {
      ...
      subtitle: "Все объявления бесплатны. Продвиньте объявление с опцией Boost.",
    ...
    createPost: {
      ...
      deleteCancel: "Отмена",
      deleteBtn: "Удалить",
      info: "Объявление бесплатно. Активно 30 дней.",
      privacy: "Политика конфиденциальности",
      terms: "Условия использования",
    },
    myPosts: {
    ...
    category: {
      ...
      ctaSubtitle: "Разместите объявление — это бесплатно!",
    },
    cookie: {
  ...
  en: {
    ...
    howItWorks: {
      ...
      step1: "Post your job",
      step1Desc:
        "Whether you need help or offer your services — it's completely free!",
      step2: "Get responses",
      step2Desc:
    ...
    ctaBanner: {
      title: "Post for free",
      titleItalic: "free",
      subtitle: "All listings are free. Boost your post to stand out.",
      btn: "Create a post",
    },
    footer: {
    ...
    createPost: {
      ...
      submitPaid: "Post for free",
      submitSave: "Save changes",
      submitCredit: "Post for free",
      ...
      deleteCancel: "Cancel",
      deleteBtn: "Delete",
      info: "Posting is free. Active for 30 days.",
      privacy: "Privacy Policy",
      terms: "Terms of Service",
    },
    myPosts: {
    ...
    category: {
      ...
      ctaSubtitle: "Post a listing — it's free!",
    },
    cookie: {
