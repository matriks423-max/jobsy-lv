  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        card: "0 4px 0 var(--ink)",
        'card-coral': "0 6px 0 var(--coral)",
        'card-sage': "0 6px 0 var(--sage)",
        'card-need': "0 6px 0 var(--need)",
        'card-mustard': "0 6px 0 var(--mustard)",
